...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3ls_w3l_banner_nav_right_grid1">
			<form action="sub_category.php" method="get">
				<p style="display: none;"><input type="text" name="s_cat_id" value="<?php echo $s_cat_id; ?>" /></p>
				<p style="display: none;"><input type="text" name="cat_id" value="<?php echo $cat_id; ?>" /></p>
				<p style="display: none;"><input type="text" name="cat_name" value="<?php echo $cat_name; ?>" /></p>
				
			<h1 style="word-wrap:break-word;"><input type="submit" name="s_cat" value="<?php  echo  $s_cat_name;?>" style="background-color:white; border: none;" /><a href="sub_category.php?s_cat_id=<?php echo $s_cat_id;?>&s_cat=<?php echo $s_cat_name;?>&cat_name=<?php echo $cat_name;?>&cat_id=<?php echo $cat_id;?>" class="btn btn-success">View All</a></h1><br>
			
			
			
			</form>
					   <?php $product_fetch = mysqli_query($query, "select * from product where category = '$cat_id' and s_cat_id = '$s_cat_id' and quantity>=1");?>
							<?php 
		 			for($i=1;$i<=3;$i++)
					{
								...
								<figure>
									...
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<a href="sub_category.php?s_cat_id=<?php echo $s_cat_id;?>&s_cat=<?php echo $s_cat_name;?>&cat_name=<?php echo $cat_name;?>&cat_id=<?php echo $cat_id;?>"><img src="images/view_more.png" hieght="200px" width="200px">
										</div>
