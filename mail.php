...
<html>
<head>
<title>Grocease: India's Biggest Online Grocery Store | Mail Us</title>
<!-- for-mobile-apps -->
			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					...
					<ul>
						...
						<li>email<span><a href="mailto:store@grocease.com">store@grocease.com</a></span></li>
					</ul>
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i></li>
						<li>call to us<span>(+91) 981 169 6208</span></li>
					</ul>
				</div>
