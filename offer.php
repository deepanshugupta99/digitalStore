	...
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				...
				<li><b>Minimum <?php echo $discount; ?>% Off </b></li>
	...
	<div class="banner">
		...
		<div class="w3ls_w3l_banner_nav_right_grid1">
					<h6><?php echo  $s_cat_name;?></h6>
					   <?php $product_fetch = mysqli_query($query, "select * from product where selling_price<=mrp-mrp*($discount/100) order by selling_price desc");?>
							<?php 
