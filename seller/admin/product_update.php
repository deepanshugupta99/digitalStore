...
//done1
session_start();
if(isset($_SESSION['mid']) && isset($_SESSION['bid'])){
...
{
  echo "<script>alert('Access Denied'); window.location.assign('myadds.php');  </script>";

}
?>
<html>
<head>
<title>Grocease: Update Product</title>
<!-- for-mobile-apps -->
...
<form role="form" name="myForm" action="update/update.php" onSubmit="return product_validation()" method="post">
